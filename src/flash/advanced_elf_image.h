...
//Fix because Elf32_Size does not exist in the current linux version of elf.h
#define Elf32_Size uint32_t //(from https://man7.org/linux/man-pages/man5/elf.5.html)
